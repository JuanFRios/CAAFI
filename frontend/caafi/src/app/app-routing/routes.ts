...
export const routes: Routes = [
  ...
  { path: 'encuestas/:dependency/:type/:form/:semester/:program/:matter/:group/:cedula', component: SurveyComponent, pathMatch: 'full' },
  { path: 'encuestas/:dependency/:type/:form/:semester/:matter/:group/:cedula', component: SurveyComponent, pathMatch: 'full' },

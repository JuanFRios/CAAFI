...
@Component({
  ...
  template: `
    <mat-form-field [hideRequiredMarker]="true" [floatLabel]="to.floatLabel" [style.width]="'100%'" matTooltip="{{to.tooltipText}}">
  ...
  `,
  providers: [{ provide: MatFormFieldControl, useExisting: TooltipWrapperComponent }],
})
export class TooltipWrapperComponent extends FieldWrapper implements OnInit, OnDestroy, MatFormFieldControl<any> {
